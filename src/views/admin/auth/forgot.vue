<template id="forgot-password">
  ...
  <div class="contents">
    ...
    <p class="font-weight-black title pa-2 ma-5" style="border-left:solid 4px #F46516; text-transform: uppercase">Forgot password</p>
    <v-card-text>
      <div>
        ...
        staffer
          ...
          .then(response => {
            if (response.data.message === 'success') {
              this.email = ''
              this.loading = false
              this.$router.push('/checkyouremail')
