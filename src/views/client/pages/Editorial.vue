        ...
        <v-row>
            ...
            <v-col cols="12">
                ...
                <v-row>
                    <v-col cols="12" md="6" v-for="article in orderBy(currentIssue.related_articles, 'article_number.field_article_number_value')" :key="article.nid">
                      <v-card flat class="mb-2" outlined hover router :to="{name: 'article', params: {article_id: article.nid}}" min-height="180">
            ...
            <v-col cols="12">
                ...
                <v-card class="pa-5 text-center" color="light-blue lighten-3" flat>
                    ...
                    <v-card-actions>
                        <v-btn color="primary" rounded block depressed href="mailto:adele.sulcas@aidspan.org">{{$t('sendemail')}}</v-btn>
                    </v-card-actions>
                </v-card>
            </v-col>
        </v-row>
