<template>
  <nav class="d-flex d-sm-none">
    <v-app-bar fixed>
      ...
      <v-toolbar-title
        v-for="title in appTitle"
        :key="title.lang"
        style="font-family: Open Sans; font-style: normal;font-weight: bold; font-size: 14px; color: #808E95;"
        class="mx-4"
      >
        {{ title.title }}
      </v-toolbar-title>
          ...
          <v-list id="menu">
            ...
            >
              <template v-slot:activator>
                <v-list-item-content>
                  <v-list-item-title
                    ><v-btn small text router :to="menu.route">{{
                      menu.title
              ...
              >
                <v-list-item-content>
                  <v-list-item-title
                    ><v-btn small router :to="subMenu.route" text>{{
                      subMenu.title
                    }}</v-btn></v-list-item-title
                  >
                </v-list-item-content>
